...
import type { RequestLoginCodeRequest, SignUpRequest, SignUpResponseData } from "../../../../types";
...
export default function FormCode({
	phone,
	optionalCheckedAgreementValues,
}: {
	phone: string;
	optionalCheckedAgreementValues: string[];
}) {
	...
	const submitCode = useCallback(
		async (code: string) => {
			try {
				const payload: SignUpRequest = {
					phone,
					code,
					agreements: optionalCheckedAgreementValues,
				};
				...
				const response = await fetch(`${API_URL}/api/widget/members/sign-up`, options);
		...
		[phone, setMember, refetchHistories, setViews, optionalCheckedAgreementValues],
	);
